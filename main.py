    ...
    try:
        ...
        if check.chat == True:
            ...
            if message.text != None:
                ...
                bot.send_message(manager, 'Сообщение с проедложение закрыть час отпрвлено пользователю')
                bot.send_message(check.user, 'Наш консультат предложил завершить онлайн чат, вы можете  это сделать отправив боту команду /no_chat\
                или же продолжить продолжить диалог')
